(function () {
  ...
  var API = "/api/apply";
  var SCHEMA_URL = "../assets/fields.json?v=4";
  ...
  function sortedCountries() {
    // The offered countries come from fields.json — this file holds no list.
    var list = ((schema && schema.countries) || []).map(function (c) {
      return { code: c, name: countryName(c) };
    });
    try {
